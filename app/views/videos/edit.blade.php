...
<div class="row">
	...
	<div class="col-sm-6">
		<form method="POST" action="{{ URL::route('editVideoPost') }}">
			<div class="form-group">
				<label class="control-label">Title</label>
				<input class="form-control" type="text" name="title" value="{{ $data['video']->title }}" />
			</div>
			<div class="form-group">
				<label class="control-label">Description</label>
				<textarea class="form-control" name="description">{{ $data['video']->description }}</textarea>
			</div>
			<div class="form-group">
